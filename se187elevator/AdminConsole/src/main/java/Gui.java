...
public class Gui extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jComboBox2.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				...
				// /Combobox setting//////////////////////////////////
				javax.swing.GroupLayout layout11 = new javax.swing.GroupLayout(
						getContentPane());
				...
				for (int j = 0; j < numbCar; j++) {
					...
					jl1.setText("Car " + (j + 1));
					j1.setModel(new javax.swing.DefaultComboBoxModel(
							new String[] { "Seq", "Even", "Odd" }));
					// javax.swing.GroupLayout layout11 = new
					// javax.swing.GroupLayout(getContentPane());
					// getContentPane().setLayout(layout11);

					/*
					 * layout11.setHorizontalGroup(
					 * layout11.createParallelGroup(
					 * javax.swing.GroupLayout.Alignment.LEADING)
					 * .addGroup(layout11
					 * .createParallelGroup(javax.swing.GroupLayout
					 * .Alignment.LEADING) .addComponent(jl1)) .addGap(18, 18,
					 * 18) .addGroup(layout11.createParallelGroup(javax.swing.
					 * GroupLayout.Alignment.LEADING, false) .addComponent(j1,
					 * 0, javax.swing.GroupLayout.DEFAULT_SIZE,
					 * Short.MAX_VALUE)) );
					 * 
					 * 
					 * layout11.setVerticalGroup(
					 * layout11.createParallelGroup(javax
					 * .swing.GroupLayout.Alignment.LEADING)
					 * .addGroup(layout11.createParallelGroup
					 * (javax.swing.GroupLayout.Alignment.LEADING)
					 * .addGroup(layout11.createSequentialGroup()
					 * .addComponent(j1, javax.swing.GroupLayout.PREFERRED_SIZE,
		...
		Authors.setBorder(javax.swing.BorderFactory.createBevelBorder(
				javax.swing.border.BevelBorder.RAISED, null,
				new java.awt.Color(0, 0, 0), null, null));
		Authors.setText("About");
		Authors.setFont(new java.awt.Font("Times New Roman", 0, 12));

		/*
		 * jMenuItem2.setText("Elevator System"); Authors.add(jMenuItem2);
		 */
	...
	class ShowElevator implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			String usrPnlBtnPressedColor = (String) jComboBox5
					.getSelectedItem();
			GuiConfiguration
					.setUserPanelPressedButtonColor(usrPnlBtnPressedColor
							.toString());

			String flrPnlClr = (String) jComboBox6.getSelectedItem();
			GuiConfiguration.setFloorPanelColor(flrPnlClr.toString());

			String flrPnlPressedBtnColor = (String) jComboBox7
					.getSelectedItem();
			GuiConfiguration
					.setFloorPanelPressedButtonColor(flrPnlPressedBtnColor
							.toString());
