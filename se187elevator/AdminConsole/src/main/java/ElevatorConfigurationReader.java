...
public class ElevatorConfigurationReader {
	...
	public static void showElevator() {
		...
		for (int j = numberOfFloors; j >= 1; j--) {
			...
			/*
			 * JLabel floorInd1= new JLabel("Car ID"); JTextField floorInd2 =
			 * new JTextField(1); JLabel floorInd3= new JLabel("Car Type");
			 * JTextField floorInd4 = new JTextField(5); JTextField floorInd5 =
			 * new JTextField(6); completeFloorPanel.add(floorInd1);
