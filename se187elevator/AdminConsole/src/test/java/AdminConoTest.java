...
public class AdminConoTest extends  TestCase{
	...
	public void testButtonColor(){
		...
		assertEquals(ElevatorConfigurationReader.resolveUserPanelColor("YELLOW"),testButtonColor);
	}
	...
	public void testActiveButtonColor(){
		...
		assertEquals(UserPanelConfiguration.getButtonColor(), UserPanelColor.BLUE);
	}
	...
	public void testButtonColor_Floor(){
		...
		assertEquals(ElevatorConfigurationReader.resolveFloorPanelColor("YELLOW"),testButtonColor);
	}
	...
	public void testActiveButtonColor_Floor(){
		...
		System.out.println(FloorPanelConfiguration.getButtonColor());
		assertEquals(FloorPanelConfiguration.getButtonColor(), FloorPanelColor.BLUE);
	}
