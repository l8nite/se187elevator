public class FloorPanelFactory {
	public static IFloorPanel createFloorPanel() {
		...
		if (FloorPanelConfiguration.getfloorPanelQueueType().equalsIgnoreCase(
				"default")) {
			ifloorPanel = new FloorPanel();
			ifloorPanel.setFloorPanelQueueType(new FloorPanelQueue());
			ifloorPanel
					.setButtonColor(FloorPanelConfiguration.getButtonColor());
			ifloorPanel.setActiveButtonColor(FloorPanelConfiguration
		...
		} else if (FloorPanelConfiguration.getTextType().equalsIgnoreCase(
				"symbol")) {
