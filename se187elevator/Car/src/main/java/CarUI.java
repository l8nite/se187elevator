...
public class CarUI extends JPanel {
	...
	private static final long serialVersionUID = -7407119074140770663L;
	...
	public CarUI(int currentFloorNumber, String carName, IDoor door,
			IUserPanel userPanel, IDoorPanel doorPanel) {
		...
		textCurrentFloorNumber.setText(new Integer(currentFloorNumber)
				.toString());
	...
	public void setCurrentFloorNumber(int currentFloorNumber) {
		...
		textCurrentFloorNumber.setOpaque(true);
		textCurrentFloorNumber.setText(new Integer(currentFloorNumber)
				.toString());
	 ...
	 * frame.setPreferredSize(new Dimension(300, 300)); SingleDoor door = new
	 * SingleDoor();
	 * 
	 * UserPanelInterface panel = new UserPanel(); panel.setNumberFloors(10);
