...
public class ShortestPathAlgorithm implements IAlgorithm {
	...
	public ICar findBestCar(List<ICar> lstCars, Direction direction,
		...
		for (int i = 1; i < lstCars.size(); i++) {
			...
			if (pathLength < car.getUserPanelQueue().pathLength(direction,
				...
				pathLength = car.getUserPanelQueue().pathLength(direction,
						destinationFloorNumber);
	...
	public static void main(String args[]) {
		...
		/*
		 * ICar car2 = new Car(); ICar car3 = new Car();
		 * 
		 * 
		 * 
		 * 
		 * ICarController carController1 = new CarController(); ICarController
		 * carController2 = new CarController(); ICarController carController3 =
		 * new CarController();
		 * 
		 * IUserPanelQueue q1 = new UserPanelQueue(); IUserPanelQueue q2 = new
		 * UserPanelQueue(); IUserPanelQueue q3 = new UserPanelQueue();
		 * 
		 * car1.setStatus(CarStatus.IDLE); car2.setStatus(CarStatus.IDLE);
		 * car3.setStatus(CarStatus.IDLE);
		 * 
		 * car1.setCurrentFloorNumber(3); car2.setCurrentFloorNumber(4);
		 * car3.setCurrentFloorNumber(5); q1.setCar(car1); q2.setCar(car2);
		 * q3.setCar(car3);
		 * 
		 * q1.putMessage(3); //q1.putMessage(2); //q1.putMessage(4);
		 * //q1.putMessage(5);
		 * 
		 * 
		 * 
		 ...
		 * 
		 * car1.setUserPanelQueue(q1); car2.setUserPanelQueue(q2);
		 * car3.setUserPanelQueue(q3);
		 * 
		 * 
		 * IUserPanel u1=new UserPanel(); u1.setSelection(1);
		 * 
		 * IUserPanel u2=new UserPanel(); u2.setSelection(2);
		 * 
		 * car1.setUserPanel(u1); car2.setUserPanel(u2); car3.setUserPanel(u1);
		 * /*carController1.setCar(car1); carController2.setCar(car2);
