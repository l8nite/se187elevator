...
public class AlgoTest extends TestCase {
	...
	/*
	 * public void testBestCarEven(){ ArrayList<ICar> arr = new
	 * ArrayList<ICar>(); ICar car1 = new Car(); IUserPanel u1=new UserPanel();
	 * ICar car2 = new Car(); IUserPanel u2=new UserPanel(); IUserPanelQueue q1
	 * = new UserPanelQueue(); IUserPanelQueue q2 = new UserPanelQueue();
	 * 
	 * //car1.setCurrentFloorNumber(4); //car2.setCurrentFloorNumber(1);
	 * 
	 * //q1.putMessage(3); //q2.putMessage(2);
	 * 
	 * u1.setSelection(1); car1.setUserPanel(u1); car1.setUserPanelQueue(q1);
	 * arr.add(car1);
	 * 
	 * u2.setSelection(2); car2.setUserPanel(u2); car2.setUserPanelQueue(q2);
	 * arr.add(car2);
	 * 
	 * salgo.findBestCar(arr, Direction.DOWN,4);
	 * //assertSame("Even Car to serve request",car1,salgo.findBestCar(arr,
	 * Direction.UP,4));
	 * 
	 * }
	 */
	...
	/*
	 * public void testBestCarOdd(){ ArrayList<ICar> arr = new
	 * ArrayList<ICar>(); ICar car1 = new Car(); IUserPanel u1=new UserPanel();
	 * ICar car2 = new Car(); IUserPanel u2=new UserPanel();
	 * 
	 * car1.setCurrentFloorNumber(4); car2.setCurrentFloorNumber(1);
	 * 
	 * 
	 ...
	 * 
	 * salgo.findBestCar(arr, Direction.UP,4);
	 * //assertSame("Odd car to serve request",car2,salgo.findBestCar(arr,
	 * Direction.UP,3)); }
	 */
